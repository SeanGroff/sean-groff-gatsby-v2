...
export default [
  ...
  },
  {
    ...
    description:
      'Enter markdown code on the left to see a live preview of your markdown code on the right. Built with React',
  ...
  },
  {
    ...
    description:
      'Built with RxJS, enter a search term and receive query results from the wikipedia API',
